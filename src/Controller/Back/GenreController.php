...
class GenreController extends AbstractController
{
    ...
    /**
     * @Route("/{genreId}", name="app_back_genre_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{genreId}/edit", name="app_back_genre_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{genreId}", name="app_back_genre_delete", methods={"POST"})
     */
